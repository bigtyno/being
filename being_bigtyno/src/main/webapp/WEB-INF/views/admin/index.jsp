...
<body>
	...
	<p class="story">
		<img class="img3"
			...
			href="${pageContext.request.contextPath}/board/list.do">스토리
			관리하러가기</a>
	</p>
	...
	<p class="store">
		<img class="img3"
			...
			width="40px" height="40px" style="margin-right: 15px;"><a
			href="${pageContext.request.contextPath}/store/list.do">상품 관리하러가기</a>
	</p>
	...
	<p class="interior">
		<img class="img3"
			...
			width="40px" height="40px" style="margin-right: 15px;"><a
			href="${pageContext.request.contextPath}/interior/list.do">업체
			관리하러가기</a>
	</p>
