	...
	<div class="search-board">
		<form action="listQuery" method="post">
			<div class="search-board">
				<select name="query">
					<!-- 
				처음 개발되었을때 IBatis 에서 대문자는 SQL 문장, 소문자는 데이터로 취급하여
				현재 버전에서는 상관이 없지만 구버전과 신버전을 통일하기위하여 대문자로 사용하면 편하다.
			 -->
					<option value="name">상품이름</option>
					<option value="brand">브랜드</option>
					<option value="keywd">키워드</option>
					...
					<li><a class="name-a-font"
						href="readStore?prodnum=${storeVO.prodnum}"> <!-- 	썸네일 --> <span
							class="store=thumbnali"> <img
								src="${pageContext.request.contextPath}/resources/img/imga.png"
