...
public class BoardController {
  ...
  public String remove(@RequestParam("num") int num, Criteria cri, RedirectAttributes rttr) throws Exception {
  ...
  public void modifyPagingGET(@RequestParam("num") int num, @ModelAttribute("cri") Criteria cri, Model model)
      throws Exception {
