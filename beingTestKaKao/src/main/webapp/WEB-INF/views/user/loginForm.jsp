      ...
      <div class="login-box-body">
         ...
         <form action="${pageContext.request.contextPath}/user/loginPost" method="post">
            ...
            <div class="row">
               ...
               <%-- <div id="kakao_id_login" style="text-align: center"> <a href="https://kauth.kakao.com/oauth/authorize?client_id=d31e8bec18195625a37e0ff70e60e749&redirect_uri=http://localhost:8080/being/&response_type=code"> 
               <img width="223" src="${pageContext.request.contextPath}/resources/img/kakao_login_large_narrow.png" /></a> </div> --%>
...
<!--             type="text/javascript"></script> -->
         ...
         <div class="login-box-etc">
            <a href="#" class="pwd1">비밀번호 찾기</a><a href="${pageContext.request.contextPath}/user/joinForm">회원 가입</a>
         </div>
