...
//			return 1;
	...
	private Store toStore(StoreWriteRequest req) {
		Date now = new Date();
		return new Store(null, req.getName(), req.getName(), req.getInfoimage(), req.getIntroduce(), req.getPrice(),
			req.getDcprice(),req.getBrand(),req.getKeywd(),req.getCategory(),req.getFreeyn(),req.getLink(),req.getAvggrade()	);
	}
}
